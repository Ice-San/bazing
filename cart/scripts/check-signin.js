...
if (userLoggedIn) {
    ...
    headerSigninBtn.classList.remove("invisible");
    mobileMenuSigninBtn.classList.remove("invisible");

    headerProfileBtn.classList.add("invisible");
    mobileMenuProfileBtn.classList.add("invisible");
}